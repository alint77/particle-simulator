...
.inner_loop:
    ...
    ; Load particle j velocities
    vmovsd  xmm4, [r12 + rbx + 40]    ; vy_j
    vmovsd  xmm3, [r12 + rbx + 48]    ; vz_j
    
    ; Update velocities for particle j using AVX2 FMA
    vfnmadd231sd xmm6, xmm0, xmm5     ; vx_j -= dx * (G*m_i/d^3)
    vfnmadd231sd xmm4, xmm1, xmm5     ; vy_j -= dy * (G*m_i/d^3)
    vfnmadd231sd xmm3, xmm2, xmm5     ; vz_j -= dz * (G*m_i/d^3)
    
    ; Store updated velocities for particle j
    vmovsd  [r12 + rbx + 32], xmm6    ; store vx_j
    vmovsd  [r12 + rbx + 40], xmm4    ; store vy_j
    vmovsd  [r12 + rbx + 48], xmm3    ; store vz_j
